...
- 更新时间：2026-07-28T11:15:30Z
- 当前阶段：`phase-0-control-plane-and-bootstrap`
- 架构版本：`1.0`
- 架构摘要：`fa6ab6cd2f4142848847c17a03d761e4cd4705a39babdf82bec3efa68ab4be9a`
- 活跃工作项：无
- 下一个可领取工作项：IOS-ANDROID-ORACLE-ATTESTATION-RECOVERY-007
- 最近完成：IOS-ANDROID-ORACLE-ATTESTATION-RECOVERY-006
...
| android_oracle | `emulator_boot_bounded` |
...
| IOS-ANDROID-ORACLE-ATTESTATION-RECOVERY-007 | 100 | `ready` | IOS-ANDROID-ORACLE-ATTESTATION-RECOVERY-006 | 绑定并验证 hosted Runner 的 AVD home |
