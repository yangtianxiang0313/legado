...
| knowledge_control_plane | `selection_and_drift_guards_verified` |
...
| IOS-KNOWLEDGE-DAG-REPAIR-001 | 95 | `ready` | IOS-KNOWLEDGE-CONTROL-PLANE-001 | 修复初始化 DAG 验收缺口并收紧知识演进门禁 |
