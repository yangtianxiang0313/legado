...
| android_oracle | `candidate_runner_verified` |
...
| ID | 优先级 | 状态 | 依赖 | 标题 |
|---|---:|---|---|---|
| IOS-ANDROID-ORACLE-ATTESTATION-001 | 100 | `ready` | IOS-ANDROID-ORACLE-RUNNER-001 | 建立 GitHub-hosted Android Oracle 双证明提案链 |
