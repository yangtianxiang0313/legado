...
- 更新时间：2026-07-28T10:15:14Z
- 当前阶段：`phase-0-control-plane-and-bootstrap`
- 架构版本：`1.0`
- 架构摘要：`fa6ab6cd2f4142848847c17a03d761e4cd4705a39babdf82bec3efa68ab4be9a`
- 活跃工作项：无
- 下一个可领取工作项：IOS-ANDROID-ORACLE-ATTESTATION-RECOVERY-006
- 最近完成：IOS-ANDROID-ORACLE-ATTESTATION-RECOVERY-005
...
| android_oracle | `github_android_tools_resolved` |
...
| IOS-ANDROID-ORACLE-ATTESTATION-RECOVERY-006 | 100 | `ready` | IOS-ANDROID-ORACLE-ATTESTATION-RECOVERY-005 | 建立有界 emulator 启动诊断 |
