...
| ID | 优先级 | 状态 | 依赖 | 标题 |
|---|---:|---|---|---|
| IOS-AUTO-MATERIALIZATION-POLICY-001 | 100 | `ready` | IOS-PROPOSAL-COMPILER-001, IOS-DECISION-GATE-POLICY-001, IOS-LOOP-SUPERVISOR-E2E-001 | 让无决策、无权威迁移的编译候选自动进入队列 |
