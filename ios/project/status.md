...
| IOS-ANDROID-ORACLE-ATTESTATION-RECOVERY-004 | 100 | `ready` | IOS-ANDROID-ORACLE-ATTESTATION-RECOVERY-003 | 恢复 GitHub-hosted adb 显式路径 |
