...
| android_oracle | `github_sdk_tools_resolved` |
...
| IOS-ANDROID-ORACLE-ATTESTATION-RECOVERY-005 | 100 | `ready` | IOS-ANDROID-ORACLE-ATTESTATION-RECOVERY-003, IOS-HARNESS-TEST-TIMEOUT-RECOVERY-002 | 恢复被基线超时阻断的 adb 显式路径 |
