...
SCENARIO_CONTRACTS = {
    ...
    "rl-library-book-detail-staging-runtime-001": {
        ...
        "expected_cases": (
            ("candidate-save-copies-progress", "detail_candidate_save"),
            ("explicit-add-persists-chapters", "detail_explicit_add"),
            ("toc-stages-without-membership", "detail_toc_stage"),
            ("zero-group-remains-candidate", "detail_group_selection"),
            ("positive-group-commits", "detail_group_selection"),
            ("reader-discard-removes-staged-book", "reader_discard_staged"),
        ),
        "nominal_cases": frozenset({
    ...
    "rl-library-chapter-toc-update-runtime-001": {
        ...
        "expected_cases": (
            ("shelf-filter-and-url-deduplicate", "shelf_toc_queue"),
            ("shelf-success-replaces-chapters", "shelf_toc_update"),
            ("shelf-missing-source-marks-error", "shelf_toc_update"),
            (
                "shelf-empty-toc-preserves-old-and-marks-error",
                "shelf_toc_update",
            ),
            ("reader-throttle-skips-request", "reader_toc_update"),
            ("reader-growth-is-accepted", "reader_toc_update"),
            ("reader-non-growth-is-rejected", "reader_toc_update"),
        ),
        "nominal_cases": frozenset({
            "shelf-filter-and-url-deduplicate",
            "shelf-success-replaces-chapters",
            "shelf-missing-source-marks-error",
            "shelf-empty-toc-preserves-old-and-marks-error",
            "reader-throttle-skips-request",
            "reader-growth-is-accepted",
            "reader-non-growth-is-rejected",
        }),
    },
    "rl-ui-reader-toc-result-001": {
        ...
        "expected_cases": (
            ("cancel-discards-payload", "toc_result_contract"),
            ("ok-null-intent-is-null", "toc_result_contract"),
            ("ok-empty-intent-uses-defaults", "toc_result_contract"),
            ("same-chapter-selection", "toc_result_contract"),
            ("different-chapter-selection", "toc_result_contract"),
            ("bookmark-selection-preserves-offset", "toc_result_contract"),
            ("reverse-result-resets-offset", "toc_result_contract"),
        ),
        "nominal_cases": frozenset({
            "cancel-discards-payload",
            "ok-null-intent-is-null",
            "ok-empty-intent-uses-defaults",
            "same-chapter-selection",
            "different-chapter-selection",
            "bookmark-selection-preserves-offset",
    ...
    "rl-reader-content-display-normalization-001": {
        ...
        "expected_cases": (
            ("plain-paragraph-normalization", "reader_content_normalization"),
            ("ordered-literal-replacements", "reader_content_normalization"),
            ("book-disabled-replacement", "reader_content_normalization"),
            ("matching-title-is-removed", "reader_content_normalization"),
            ("replaced-title-is-removed", "reader_content_normalization"),
            ("scope-and-disabled-rules-are-filtered", "reader_content_normalization"),
        ),
        "nominal_cases": frozenset({
            "plain-paragraph-normalization",
            "ordered-literal-replacements",
            "book-disabled-replacement",
            "matching-title-is-removed",
            "replaced-title-is-removed",
            "scope-and-disabled-rules-are-filtered",
        }),
    },
    "rl-reader-session-chapter-navigation-001": {
        ...
        "stage_names": (
            "fixture_setup",
            "navigation_attempt",
            "chapter_window_rotation",
            "progress_projection",
            "result_mapping",
        ),
        "expected_cases": (
            ("next-page-advances-to-page-start", "reader_chapter_navigation"),
            ("next-page-at-end-is-denied", "reader_chapter_navigation"),
            ("previous-page-returns-to-page-start", "reader_chapter_navigation"),
            ("previous-page-at-start-is-denied", "reader_chapter_navigation"),
            ("next-chapter-rotates-preloaded-window", "reader_chapter_navigation"),
            ("previous-chapter-uses-preloaded-last-page", "reader_chapter_navigation"),
            ("missing-previous-chapter-requests-max-position", "reader_chapter_navigation"),
            ("last-chapter-cannot-advance", "reader_chapter_navigation"),
            ("first-chapter-cannot-retreat", "reader_chapter_navigation"),
        ),
        "nominal_cases": frozenset({
            "next-page-advances-to-page-start",
            "next-page-at-end-is-denied",
            "previous-page-returns-to-page-start",
            "previous-page-at-start-is-denied",
            "next-chapter-rotates-preloaded-window",
            "previous-chapter-uses-preloaded-last-page",
            "missing-previous-chapter-requests-max-position",
            "last-chapter-cannot-advance",
    ...
    "rl-integration-backup-ios-replacerule-to-android-001": {
        ...
        "expected_cases": (
            (
                "ios-replace-rule-archive-restores-on-android",
    ...
    "rl-integration-backup-ios-library-to-android-001": {
        ...
        "expected_cases": (
            (
                "ios-library-archive-restores-on-android",
