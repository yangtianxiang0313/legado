...
class LoopSupervisor:
    ...
    def _golden_consumer_recovery_scope_issues(
        self,
        item: Mapping[str, Any],
    ) -> List[str]:
        metadata = item.get("metadata", {})
        ...
        required_denials = (
            ...
            "ios/project/status.md",
            "ios/project/business-knowledge/catalog.json",
            "ios/project/delivery-intents/example.json",
            "ios/project/migration-intents/example.json",
            "ios/project/requirements/catalog.json",
            "ios/project/approvals/decision.json",
            "ios/project/work-item-proposals/candidate.json",
            "ios/docs/architecture.md",
    ...
    def _auto_candidate(
        ...
        *,
        ...
        elif golden_consumer_recovery:
            consumer_issues = (
                self._golden_consumer_recovery_scope_issues(item)
            )
            if consumer_issues:
                raise MaterializationConflict(
