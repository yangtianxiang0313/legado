...
struct AndroidCoreBackupRestoreUseCaseTests {
  @Test func restoresEveryPresentCoreDomain() async throws {
    ...
    try AndroidBackupArchive.write(
      AndroidBackupContents(
        ...
        sharedPreferences: AndroidSharedPreferencesDocument(values: [
          ...
          AndroidApplicationBackupPreferences.threadCountKey: .int(8),
          ...
          AndroidApplicationBackupPreferences.tocUiUseReplaceKey:
            .boolean(true),
    ...
    #expect(summary.applicationPreferenceCount == 18)
    ...
    #expect(snapshot.searchScopePreferences?.sourceConcurrency == 8)
    #expect(
    ...
    #expect(snapshot.readerPreferences?.tocUsesReplacementRules == true)
  }
