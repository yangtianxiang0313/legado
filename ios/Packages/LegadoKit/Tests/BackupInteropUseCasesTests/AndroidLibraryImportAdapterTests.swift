...
@Test func mapsAndroidLibraryWithoutCollapsingGroupMask() throws {
  ...
  #expect(restored.resegmentsContent)
  #expect(restored.pageAnimation == 3)
  #expect(restored.deletedEPUBTagMask == 6)
