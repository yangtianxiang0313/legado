...
def owner_contract(target: str) -> Mapping[str, Any]:
    if target == "IOS-DEPENDENCY-ZIPFOUNDATION-ARCHIVE-001":
        return {
    ...
    if target == "IOS-INTEGRATION-ANDROID-BACKUP-AES-001":
        return {
            "owner": "IntegrationKit",
            "architecture_refs": [
                "ARCH-001",
    ...
    if target == "IOS-APP-ANDROID-WEBDAV-CONFIG-RESTORE-001":
        return {
            "owner": "AppNavigation",
            "architecture_refs": [
                "ARCH-001",
    ...
    if target == "IOS-APP-IOS-WEBDAV-CONFIG-ANDROID-EXPORT-001":
        return {
            "owner": "AppNavigation",
            "architecture_refs": [
                "ARCH-001",
    ...
    if target == "IOS-INTEGRATION-ANDROID-BACKUP-LIBRARY-INTEROP-001":
        return {
            "owner": "IntegrationKit",
            "architecture_refs": [
                "ARCH-001",
    ...
    if target == "IOS-APP-SHELF-ANDROID-GROUP-SEMANTICS-001":
        return {
            "owner": "AppNavigation",
            "architecture_refs": [
                "ARCH-001",
    ...
    if target == "IOS-APP-NAVIGATION-ANDROID-LIBRARY-EXPORT-001":
        return {
            "owner": "AppNavigation",
            "architecture_refs": [
                "ARCH-001",
    ...
    if target == "IOS-APP-NAVIGATION-ANDROID-CORE-RESTORE-001":
        return {
            "owner": "AppNavigation",
            "architecture_refs": [
                "ARCH-001",
    ...
    if target == "IOS-INTEGRATION-ANDROID-READ-RECORD-INTEROP-001":
        return {
            "owner": "IntegrationKit",
            "architecture_refs": [
                "ARCH-001",
    ...
    if target == "IOS-READER-NATIVE-READ-RECORD-TRACKING-001":
        return {
            "owner": "ReaderCore",
            "architecture_refs": [
                "ARCH-001",
...
def build_task(root: Path, delivery: Mapping[str, Any]) -> Mapping[str, Any]:
    ...
    if target == "IOS-INTEGRATION-ANDROID-BACKUP-LIBRARY-INTEROP-001":
        delivery_contracts["IntegrationKit"] = {
            "goal": (
                "依据冻结 Android Book、BookGroup、Bookmark、Backup 与 Restore "
                "源码，实现用户书库三文件无损 codec，并由真实 Android 恢复"
                "iOS 生成的组合归档。"
            ),
            "rule": (
                "格式 DTO 留在 AndroidBackupInterop；未知字段、嵌套 readConfig"
                "与整数 token 无损。不得用当前不完整的 iOS 分组模型冒充映射完成。"
            ),
